...
% Ondas Electromagnéticas - Parte 1
...
% Ondas Electromagnéticas - Parte 2
...
% Magnetostática y Transformadores
...
\begin{table}[H]
    ...
    \resizebox{0.48\textwidth}{!}{
        \begin{tabular}{|c|c|}
            ...
            \hline
            Relación D, E y P       & $\vec{D} = \epsilon_0 \vec{E} + \vec{P}$                                     \\
            \hline
            Vector de polarización  & $\vec{P} = \epsilon_0 \chi_e \vec{E}$                                        \\
            \hline
